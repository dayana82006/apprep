...
namespace AplMovilBexsolucionesApi.Controllers
{
    ...
    public class ProductosController : ControllerBase
    {
        ...
        /// <summary>
        /// Consulta de la lista de items disponibles para Productos.
        /// </summary>
        ...
        /// <returns> Un IActionResult que contiene la lista paginada de elementos de Productos para la página especificada.MAXIMO 10000 items por pagina.</returns>
        [HttpGet]
