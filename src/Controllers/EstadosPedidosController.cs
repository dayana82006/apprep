...
namespace AplMovilBexsolucionesApi.Controllers
{
    ...
    public class EstadosPedidosController : ControllerBase
    {
        ...
        /// <returns> Un IActionResult que contiene la lista paginada de elementos de Estados de Pedidos para la página especificada.MAXIMO 10000 items por pagina.</returns>
