...
namespace AplMovilBexsolucionesApi.Controllers
{
    ...
    public class PreciosController : ControllerBase
    {
        ...
        /// <summary>
        /// Consulta de la lista de items disponibles para Precios.
        /// </summary>
        ...
        /// <returns> Un IActionResult que contiene la lista paginada de elementos de Precios para la página especificada.MAXIMO 10000 items por pagina.</returns>
        [HttpGet]
        [ProducesResponseType(typeof(IEnumerable<PrecioDto>), 200)]
